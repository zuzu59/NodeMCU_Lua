-- Affiche simplement plusieurs lignes sur le mini display OLED du MiniD1
...
print("\n oled_disp_multi_lines.lua   zf180823.1106   \n")
...
--    disp:drawStr(0,0,"Hello zuzu !")
    disp:drawStr(0,0,"ligne 1")
    disp:drawStr(0,10,"ligne 1")
    disp:drawStr(0,20,"ligne 1")
    disp:drawStr(0,30,"ligne 1"..string.char(233)..":")  -- affiche un é !
    disp:drawStr(0,40,"ligne 1")
